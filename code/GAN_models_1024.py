...
def generator_model(x_shape,y_shape):
    ...
    conv6_1024 = Conv2D(1024,kernel_size=(3,3),padding='same',activation='elu',kernel_regularizer=l2(0.001))(conv6_512)
    conv6_1024 = Conv2D(1024,kernel_size=(3,3),padding='same',activation='elu',kernel_regularizer=l2(0.001))(conv6_512)
    conv6_1024 = MaxPooling2D(pool_size=(2,2),padding="same")(conv6_1024)
    conv6_1024 = BatchNormalization()(conv6_1024)
    
    conv7_512 = Conv2D(1024,kernel_size=(3,3),padding='same',activation='elu',kernel_regularizer=l2(0.001))(conv6_1024)
    conv7_512 = BatchNormalization()(conv7_512)
    
    # decoder
    conv8_1024 = Conv2D(1024,kernel_size=(3,3),padding='same',activation='elu',kernel_regularizer=l2(0.001))(conv7_512)
    conv8_1024 = BatchNormalization(axis=1)(conv8_1024)

    deconv9_512b = Conv2DTranspose(1024,kernel_size=(3,3),padding='same',activation='elu',strides=(2,2),kernel_regularizer=l2(0.001))(conv8_1024)
    deconv9_512b = BatchNormalization()(deconv9_512b)
    deconv9_512b = Concatenate()([deconv9_512b,deconv9_512b])
    deconv9_512b = Conv2D(512,kernel_size=(3,3),padding='same',activation='elu',kernel_regularizer=l2(0.001))(deconv9_512b)
    deconv9_512b = BatchNormalization()(deconv9_512b)

    
    deconv9_512 = Conv2DTranspose(512,kernel_size=(3,3),padding='same',activation='elu',strides=(2,2),kernel_regularizer=l2(0.001))(deconv9_512b)
